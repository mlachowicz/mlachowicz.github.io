...
It seems that using this default linux/x86/meterpreter/reverse_tcp payload doesn't lead us anywhere so I'm sending a ^C kill signal by pressing CTRL+C to cancel the module. I'm checking what else payloads we can set for this module...
