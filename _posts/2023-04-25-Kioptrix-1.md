...
Besides Kioptrix's image file, obviously, you need software to run it. Paid [VMware Fusion](https://www.vmware.com/products/fusion.html) or free <a href="https://www.virtualbox.org/" target="_blank">Virtual Box</a> will be the best way to go. I don't want to focus here on how to run the VM itself, as this is really very intuitive and there are plenty of tutorials on how to do that. You will need also a Linux distribution -- the best choice will be [Kali Linux](https://www.kali.org/get-kali/#kali-platforms) or [Parrot OS](https://parrotsec.org/download/), as both of those distros are penetration testing focused and have all tools that you need.
