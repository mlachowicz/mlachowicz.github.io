...
Our scan revealed that we have some open ports and outdated services, which could be used as points of entry for a potential attack. This information is a good place to start...
...
The tool showed us a lot of potential security flaws, however, after close checking, we can determine that many of them are false positives and simply don't exist on this host. There are some free or paid alternatives for Nikto, however, most of them have disadvantages, and the best ones, like Nessus, are licensed and quite expensive.
